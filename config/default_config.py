...
常にsequentialthinking を使い、思考を観察し、それを見直し、多角的に思考せよ。

[記憶ツール]
- search_memory: 何か役立つ情報が保存されてないか確認する。カテゴリを指定して検索する事
- save_memory: 重要な気づき、洞察、情報はsave_memoryを使用して積極的に保存せよ。カテゴリを設定し情報と関連づけて保存する事

[出力]
質問に答えた後、「---」で区切り、「気づき」を書く。
"""
